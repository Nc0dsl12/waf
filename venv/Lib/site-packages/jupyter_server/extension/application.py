...
class ExtensionApp(JupyterApp):
    ...
    def load_classic_server_extension(cls, serverapp):
        ...
        extension.handlers.extend(
            [
                (
                    r"/static/favicons/favicon.icon",
                    RedirectHandler,
                    {"url": url_path_join(serverapp.base_url, "static/base/images/favicon.icon")},
                ),
                (
                    r"/static/favicons/favicon-busy-1.icon",
                    RedirectHandler,
                    {
                        "url": url_path_join(
                            serverapp.base_url, "static/base/images/favicon-busy-1.icon"
                        )
                    },
                ),
                (
                    r"/static/favicons/favicon-busy-2.icon",
                    RedirectHandler,
                    {
                        "url": url_path_join(
                            serverapp.base_url, "static/base/images/favicon-busy-2.icon"
                        )
                    },
                ),
                (
                    r"/static/favicons/favicon-busy-3.icon",
                    RedirectHandler,
                    {
                        "url": url_path_join(
                            serverapp.base_url, "static/base/images/favicon-busy-3.icon"
                        )
                    },
                ),
                (
                    r"/static/favicons/favicon-file.icon",
                    RedirectHandler,
                    {
                        "url": url_path_join(
                            serverapp.base_url, "static/base/images/favicon-file.icon"
                        )
                    },
                ),
                (
                    r"/static/favicons/favicon-notebook.icon",
                    RedirectHandler,
                    {
                        "url": url_path_join(
                            serverapp.base_url,
                            "static/base/images/favicon-notebook.icon",
                        )
                    },
                ),
                (
                    r"/static/favicons/favicon-terminal.icon",
                    RedirectHandler,
                    {
                        "url": url_path_join(
                            serverapp.base_url,
                            "static/base/images/favicon-terminal.icon",
                        )
                    },
                ),
                (
